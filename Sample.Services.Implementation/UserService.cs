...
/// <summary>
/// Example dependency-injected interface
/// </summary>
...
/// <summary>
/// Example for a depdendency-injected object
/// </summary>
public class FakeUserProvider : IUserProvider
{
    public string GetEmail() => "megger@eps-software.com";
    public string GetFirstname() => "Markus";
    public string GetLastname() => "Egger";
}
