...
namespace CODE.Framework.Fundamentals.Utilities
{
    ...
    /// EPS.Utilities.LoggingMediator.Log("A critical error occurred!", EPS.Utilities.LogEventType.Critical | EPS.Utilities.LogEventType.Error);
    /// </example>
    ...
    public class EventLogLogger : Logger
    {
        ...
        /// <param name="type">The event type.</param>
        /// <remarks>
        /// CODE Framework log types are mapped to the following system event types (in this order):
